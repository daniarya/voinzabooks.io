...
do
{
	...
	$item = $xml->Items->Item;
	if($vb==100)die('<META HTTP-EQUIV="refresh" content="0;URL=./?book=404">');
	}while(empty($item));
...
$semilar= $similar_product;
	...
	$konten1 = 'This awesome book ready for download, you can get this book now for <strong> FREE </strong>.';
